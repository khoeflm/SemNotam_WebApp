...
/**
 * <p>Java-Klasse für evaluateInterestSpecificationResponse complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="evaluateInterestSpecificationResponse"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "evaluateInterestSpecificationResponse", propOrder = {
    "_return"
})
public class EvaluateInterestSpecificationResponse {
